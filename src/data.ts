...
export const CHARACTERS: CharacterItem[] = [
  ...
  },
  {
    ...
    roleJa: 'タピオカ親衛隊の隊長',
    descEn: 'King Tapioca’s best friend and captain of the personal guard. He looks like a round green gelatin with crossed "X X" eyes, but he is actually a mechanical robot! He is controlled by a tiny, adorable pilot sleeping of working hard inside.',
